          ...
          <form onSubmit={handleSubmit} className="p-5 space-y-4 max-h-[70vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                ...
                <select id="eq-create-type" name="type" value={type} onChange={(e) => setType(e.target.value)} className="input-industrial w-full">
                  {TYPES.map((t) => (
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                ...
                <select id="eq-create-statut" name="statut" value={statut} onChange={(e) => setStatut(e.target.value)} className="input-industrial w-full">
                  {STATUSES.map((s) => (
            ...
            <div className="flex items-center gap-2">
              <input
                id="eq-create-contactAlimentaire"
