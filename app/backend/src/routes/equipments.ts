...
const createEquipmentSchema = z.object({
  ...
  isAtex: z.boolean().default(false),
  dateDerniereInspectionAtex: z.coerce.date().optional().nullable(),
  dateProchaineInspectionAtex: z.coerce.date().optional().nullable(),
  ...
  model: z.string().max(100).optional().nullable().transform(sanitizeOptionalString),
  capacite: z.string().max(100).optional().nullable().transform(sanitizeOptionalString),
  alimentation: z.string().max(100).optional().nullable().transform(sanitizeOptionalString),
  dimensions: z.string().max(100).optional().nullable().transform(sanitizeOptionalString),
  poids: z.string().max(100).optional().nullable().transform(sanitizeOptionalString),
  coutArretHeure: z.coerce.number().min(0).optional().nullable(),
