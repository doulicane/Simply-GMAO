# Roadmap de Développement — GMAO Simply GMAO
...
- **Fonctionnalités livrées :**
  ...
  - STK-016 : Articles critiques Simply GMAO (liste préconfigurée)
...
- **Risques / Hypothèses :**
  ...
  - **Hypothèse :** Les procédures ATEX existantes de Simply GMAO sont fournies (consignation, permis de feu, inspection)
...
- **Tâches techniques :**
  - [ ] Template HTML/CSS rapport mensuel avec logo Simply GMAO
...
| **URL** | `https://gmao-test.simply-gmao.local` |
...
| **URL** | `https://gmao.simply-gmao.local` |
...
> **Note :** Ce budget correspond à une solution **sur mesure** développée spécifiquement pour Simply GMAO. Si l'option SaaS légère (MaintainX, Limble, UpKeep) est retenue, le budget V1 serait réduit à ~10 000-15 000 € (paramétrage + formation) mais avec moins de personnalisation ATEX et offline.
...
*Document produit pour le projet GMAO Simply GMAO — Roadmap de développement agile, sprints 2 semaines, prête pour exécution.*
