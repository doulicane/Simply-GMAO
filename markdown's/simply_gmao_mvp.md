# MVP Priorisé avec User Stories — GMAO Simply GMAO
...
| W5 | Multi-site (5 sites Simply GMAO) | Pilote 1 site d'abord | V3 |
...
**Verdict :** Le SaaS légère est le meilleur compromis pour Simply GMAO : déploiement rapide, coût maîtrisé, mobile-first, pas de dette technique. L'open source (GLPI, OpenMAINT) est une alternative viable si la DSI a des compétences PHP/Python disponibles.
