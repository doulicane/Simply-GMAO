# Spécifications Fonctionnelles Détaillées — GMAO Simply GMAO
...
| Niveau | Exemple Simply GMAO | Usage |
|--------|-------------------|-------|
...
**Exemples de plan préventif Simply GMAO :**
...
#### 3.4.4 Articles critiques Simply GMAO (à configurer en priorité)
...
Les sites Simply GMAO utilisent de la **poudre d'aluminium** (feuilles alliage 8011, 0.20–0.23 mm) qui présente un risque d'explosion de poussières (ATEX). Les installations laquage utilisent des solvants et des encres à l'eau sans solvant en contact avec des emballages alimentaires.
...
- Rapport 1 : Contexte entreprise Simply GMAO (fondation, sites, processus, certifications)
