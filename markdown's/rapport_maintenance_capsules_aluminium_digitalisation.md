...
## Usine de Fabrication de Capsules Aluminium (type Simply GMAO)
...
Une usine de capsules aluminium de type Simply GMAO (ou équivalent : Pelliconi, Guala Closures, etc.) compte typiquement 4 à 8 lignes de production. Chaque ligne intègre les équipements suivants, classés par criticité pour la maintenance :
